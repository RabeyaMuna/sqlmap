...
def vulnTest():
    ...
    TESTS = (
        ...
        (
            '-c <config> --flush-session --output-dir="<tmpdir>" --smart --roles --statements --hostname --privileges --sql-query="SELECT \'\u0161u\u0107uraj\'" --technique=U',
            (
                ": '\u0161u\u0107uraj'",
        ...
        (
            "-u <url> --flush-session --sql-query=\"SELECT '\u0161u\u0107uraj'\" --technique=B --no-escape --string=luther --unstable",
            (": '\u0161u\u0107uraj'",),
        ),
        (
